package com.example.bookingsfrontend.view;

import com.example.bookingsfrontend.ScreenBounds;
import com.example.bookingsfrontend.controller.CreateBookingFormController;
...
public class CreateBookingFormView {
    ...
    public void display(Stage primaryStage) {
        ...
        stage.setHeight(ScreenBounds.getWindowHeight(0.45));
        stage.setMinHeight(ScreenBounds.getWindowHeight(0.45));
        stage.setWidth(ScreenBounds.getWindowWidth(0.35));
        stage.setMinWidth(ScreenBounds.getWindowWidth(0.35));
